...
class Order extends Component {
    constructor(props){
        ...
        this.setState({ settings: props.context.settings });
    ...
    validateForm(e) {
        ...
        if (hh < startHH || (hh === startHH && mm < startMM)) {
            ...
            this.addToCart(this.state.newOrder)
        }    
    }
    ...
    addToCart = newOrder => {
        ...
        // const addDataIntoCache = (cacheName, url, response) => {
            ...
            // const data = new Response(JSON.stringify(this.state.newOrder));
            // const url = window.location.href;
            // // console.log(url);

            // if ('caches' in window) {
            //   // Opening given cache and putting our data into it
            //     caches.open("PizzaCart").then((cache) => {
            //         cache.put(url, data);
            ...
            if (prevOrders) {
                addOrders.push(prevOrders)                
            } 
            // this.state.cartOrders.push(newOrder)
            addOrders.push(newOrder)
            

            // console.log(`NewOrders: ${addOrders}`)
            localStorage.setItem('pizza', JSON.stringify(addOrders));
            alert('Order added to cart!')
    }
